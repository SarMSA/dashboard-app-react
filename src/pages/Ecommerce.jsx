...
const Ecommerce = () => {
  const { currentColor, themeMode } = useStateContext();
  return (
    <div className="mt-12">
      <div className="flex flex-wrap lg:flex-nowrap justify-center">
        ...
        <div className="flex m-3 flex-wrap justify-center items-center gap-1">
          {earningData.map((item) => (
            <div
              key={item.title}
              className="bg-white dark:text-gray-200 dark:bg-secondary-dark-bg h-44 rounded-3xl md:w-56 p-4 pt-9 text-center"
            >
              <button
                type="button"
      ...
      <div className="flex flex-wrap justify-center">
        <div className="bg-white dark:text-gray-200 p-5 dark:bg-secondary-dark-bg m-3 rounded-2xl md:w-780">
